...
type AdminRow = {
  user_id: string; // Fixed: using user_id from your DB schema
  email: string;
  phone: string | null;
      ...
      {pwUserId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl space-y-4">
            ...
            <input
              className="w-full border rounded-xl px-4 py-3 outline-none focus:ring-2 ring-blue-500 border-gray-200"
