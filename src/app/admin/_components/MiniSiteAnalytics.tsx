// src/app/admin/_components/MiniSiteAnalytics.tsx
"use client";
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm overflow-hidden">
      <div className="p-4 border-b bg-gray-50 flex items-center justify-between">
        ...
        <Link href="/admin/site-events" className="text-xs font-semibold px-3 py-2 rounded border bg-white hover:bg-gray-50">
          View details →
        </Link>
      </div>
      ...
      <div className="p-4 grid grid-cols-2 md:grid-cols-6 gap-3">
        ...
        <Kpi title="Organic Redirects" value={traffic.organic} tone="emerald" />
        <Kpi title="Direct Redirects" value={traffic.direct} tone="amber" />
        <Kpi title="Paid Redirects" value={traffic.paid} tone="sky" />
      </div>
