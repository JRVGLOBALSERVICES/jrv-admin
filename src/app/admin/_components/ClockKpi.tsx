...
export default function ClockKpi() {
    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-4 md:p-6 overflow-hidden relative group hover:shadow-2xl transition-all duration-300 h-full flex items-center justify-center">
