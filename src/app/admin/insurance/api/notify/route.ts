...
import { buildUnifiedAlert, sendSlackNotification } from "@/lib/slack";
...
export async function POST(req: Request) {
  ...
  const slackMsg = buildUnifiedAlert("INSURANCE", expiringCars);
  ...
  console.log(
    "NOTIFY: Using Webhook:",
    webhookUrl ? "Yes (Defined)" : "No (Undefined/Empty)"
  );
